...
{   
    ...
    switch (event->event_id) 
    {
        ...
        case SYSTEM_EVENT_STA_DISCONNECTED:
            ...
            display_value_debug("Connecting..",12,ui32_counter_disconnected,3);
            display_string_debug((char*)wifi_config_sta.sta.ssid,strlen((char*)wifi_config_sta.sta.ssid),4);
        ...
        case SYSTEM_EVENT_AP_START:
            ...
            display_string_debug("AP Mode",7,3);
             display_string_debug((char*)wifi_config_ap.ap.ssid,strlen((char*)wifi_config_ap.ap.ssid),4);
            ui32_WiFi_status = WIFI_DISCONNECT; 
            break;
